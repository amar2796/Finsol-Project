...
namespace FIN
{
	...
	public:
		...
		void            insertBuyDepth(const PRICE, const UNSIGNED_INT_32, int32_t pos);
		void            insertSellDepth(const PRICE, const UNSIGNED_INT_32, int32_t pos);
		void            updateBuyDepth(const PRICE, const UNSIGNED_INT_16);
		void            updateBuyDepth_Overlay(const PRICE, const UNSIGNED_INT_16 , UNSIGNED_INT_16);
		void            updateSellDepth(const PRICE, const UNSIGNED_INT_16);
		void            updateSellDepth_Overlay(const PRICE, const UNSIGNED_INT_16, UNSIGNED_INT_16);
