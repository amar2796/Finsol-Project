...
namespace FIN
{
	...
	* @Return UNSIGNED_INT_16.
	*/
	UNSIGNED_INT_16 Depth::getQty() const
	{
		return _qty;
	}
	/**
	...
	*@Return nothing.
	*/
	void Depth::setQty(const UNSIGNED_INT_16 qty)
	{
		_qty = qty;
	}
	/**
	...
	*/
	...
	void MarketData::setOpenInterest(const SIGNED_INT_64 price) 
	{
		_openInterest = price;
	}
	...
	*/
	...
	void MarketData::updateBuyDepth_Overlay(const PRICE changed_price, const UNSIGNED_INT_16 qty, UNSIGNED_INT_16 pos)
	{
	...
	*/
	...
	void MarketData::updateSellDepth_Overlay(const PRICE changed_price, const UNSIGNED_INT_16 qty, UNSIGNED_INT_16 pos)
	{
...
*@Return nothing.
*/
	void MarketData::insertBuyDepth(const PRICE price, const UNSIGNED_INT_32 qty, int32_t pos)
	{
	...
	*@Return nothing.
	*/
	void MarketData::insertSellDepth(const PRICE price, const UNSIGNED_INT_32 qty, int32_t pos)
	{
