...
namespace FIN {
    ...
    private:
        ...
        void readConfig()
        {
            ...
            _exchangeName = "SenderEx" + _memberId + std::to_string(_exchange_number);
            _exchangeType = "direct";
            _routingKey   = "sender"+_memberId + std::to_string(_exchange_number);
            _queueName    = "OMSSenderQueue"+_memberId + std::to_string(_exchange_number);
