...
*/
	...
	void MarketData::insertBuyPriceInPosition(const PRICE price, const int32_t pos)
	{
		_buyDepth[pos].setPrice(price);
	}
	void MarketData::insertBuyQtyInPosition(const QUANTITY qty, const int32_t pos)
	{
		_buyDepth[pos].setQty(qty);
	}
	void MarketData::insertSellPriceInPosition(const PRICE price, const int32_t pos)
	{
		_sellDepth[pos].setPrice(price);
	}
	void MarketData::insertSellQtyInPosition(const QUANTITY qty, const int32_t pos)
	{
		_sellDepth[pos].setQty(qty);
	}
...
*/
	...
	*/
	void DPR::print() const
	{
		...
		std::cout << "lowerLimit: " << _lowerLimit << "\n";
		FIN_DEVLOG("*********** DPR_END ************");
	...
	*/
	...
	/**
	* Get close price of the market.
	* @Return PRICE.
	*/
	PRICE DPR::getClosePrice() const
	{
		return _closePrice;
	}
	/**
...
*/
	...
	*/
	...
	//CONTRACT_ACTION PRINT
	void CONTRACTACTION::print() const
	{
		FIN_DEVLOG("*********** CONTRACT_ACTION_START ************");
		BroadCastMsgHeader::print();
		std::cout << "SecurityID : " << _secId << std::endl;
		std::cout << "Action	 : " << _action << std::endl;
		FIN_DEVLOG("*********** CONTRACT_ACTION_END ************");
	}

	//SET ACTION TO TAKE DESIGE OMS
	void CONTRACTACTION::setAction(const SIGNED_INT_8 val)
	{
		_action = val;
	}

	//GET ACTION 
	SIGNED_INT_8 CONTRACTACTION::getAction() const
	{
		return _action;
	}

	//CONTRACT_ACTION PRINT
	void MARKETRESUMEACTION::print() const
	{
		FIN_DEVLOG("*********** MARKET_RESUME_ACTION_START ************");
		BroadCastMsgHeader::print();
		std::cout << "Action : " << _action << std::endl;
		FIN_DEVLOG("*********** MARKET_RESUME_ACTION_END ************");
	}

	//SET ACTION TO TAKE DESIGE OMS
	void MARKETRESUMEACTION::setAction(const SIGNED_INT_8 val)
	{
		_action = val;
	}

	//GET ACTION 
	SIGNED_INT_8 MARKETRESUMEACTION::getAction() const
	{
		return _action;
	}
}
