#ifndef RABBITMQ_INTIALIZER_TBT
#define RABBITMQ_INTIALIZER_TBT
...
namespace FIN
{
	class RbInitializerTBT
	{
	public:

		RbInitializerTBT(const int _rabbitPort, const std::string& _rabbitIp, const std::string& _exchangeName,
