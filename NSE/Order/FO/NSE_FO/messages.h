			...
			*/
				...
				struct GR_REQUEST : public DC_PACKET_WRAPPER, public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setBoxID(boost::lexical_cast<short>  (result[9]));
						setBrokerID((result[10]));
						setFiller(boost::lexical_cast<char>  (result[11]));
						print();
					}
				...
				struct GR_RESPONSE : public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setPort(boost::lexical_cast<char>(result[13]));
				...
				struct ST_BROKER_ELIGIBILITY_PER_MKT
				{
					...
					void fromString(std::string& str)
					{
						...
						setReserved1(boost::lexical_cast<unsigned char>  (result[0]));
						setReserved2(boost::lexical_cast<unsigned char>  (result[1]));
						setReserved3(boost::lexical_cast<unsigned char>  (result[2]));
						setReserved4(boost::lexical_cast<unsigned char>  (result[3]));
						setAuction(boost::lexical_cast<unsigned char>  (result[4]));
						setSpot(boost::lexical_cast<unsigned char>  (result[5]));
						setOddlot(boost::lexical_cast<unsigned char>  (result[6]));
						setNormal(boost::lexical_cast<unsigned char>  (result[7]));
						setReserved5(boost::lexical_cast<char>  (result[8]));
						print();
					}
				...
				struct MS_SIGNON : public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setUserID(boost::lexical_cast<short>  (result[9]));
						setReserved2(result[11]);
						setPassword(result[12]);
						setReserved3(result[13]);
						setNewPassword(result[14]);
						setTraderName(result[15]);
						setLastPasswordChangeDate(boost::lexical_cast<short>  (result[16]));
						setBrokerID(result[17]);
						setReserved(boost::lexical_cast<short>  (result[18]));
						setBranchID(boost::lexical_cast<short>  (result[19]));
						setVersionNumber(boost::lexical_cast<short>  (result[20]));
						setBatch2StartTime(boost::lexical_cast<short>  (result[21]));
						setHostSwitchContext(boost::lexical_cast<short>  (result[22]));
						setColour(result[23]);
						setReserved1(boost::lexical_cast<short>  (result[24]));
						setUserType(boost::lexical_cast<short>  (result[25]));
						setSequenceNumber(boost::lexical_cast<short>  (result[26]));
						setWsClassName(result[27]);
						setBrokerStatus(boost::lexical_cast<short>  (result[28]));
						setShowIndex(boost::lexical_cast<short>  (result[29]));
						setMemberType(boost::lexical_cast<short>  (result[30]));
						setClearingStatus(boost::lexical_cast<short>  (result[31]));
				...
				struct SIGNON_CONFIRMATION : public MS_SIGNON
				{
					...
					void fromString(std::string& str)
					{
						...
						setLastPasswordChangeDate(boost::lexical_cast<short>  (result[15]));
						setBrokerID(result[16]);
						setReserved(boost::lexical_cast<short>  (result[17]));
						setBranchID(boost::lexical_cast<short>  (result[18]));
						setVersionNumber(boost::lexical_cast<short>  (result[19]));
						setBatch2StartTime(boost::lexical_cast<short>  (result[20]));
						setHostSwitchContext(boost::lexical_cast<short>  (result[21]));
						setColour(result[22]);
						setReserved1(boost::lexical_cast<short>  (result[23]));
						setUserType(boost::lexical_cast<short>  (result[24]));
						setSequenceNumber(boost::lexical_cast<short>  (result[25]));
						setWsClassName(result[26]);
						setBrokerStatus(boost::lexical_cast<short>  (result[27]));
						setShowIndex(boost::lexical_cast<short>  (result[28]));
						setMemberType(boost::lexical_cast<short>  (result[29]));
						setClearingStatus(boost::lexical_cast<short>  (result[30]));
				...
				struct MS_SYSTEM_INFO_REQ : public DC_PACKET_WRAPPER, public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setLastUpdatePortfolioTIme(boost::lexical_cast<long>  (result[9]));
						print();
					}
					void reset()
					{
				...
				struct ST_MARKET_STATUS
				{
					...
					void fromString(std::string& str)
					{
						...
						setNormal(boost::lexical_cast <short> (result[0]));
						setOddLot(boost::lexical_cast <short> (result[1]));
						setSpot(boost::lexical_cast <short> (result[2]));
						setAuction(boost::lexical_cast <short> (result[3]));
						print();
					}
					void print() const
					{
				...
				public:
					...
					void fromString(std::string& str)
					{
						...
						setReserved1(boost::lexical_cast <char> (result[0]));
						setReserved2(boost::lexical_cast <char> (result[1]));
						setReserved3(boost::lexical_cast <char> (result[2]));
						setReserved4(boost::lexical_cast <char> (result[3]));
						setReserved5(boost::lexical_cast <char> (result[4]));
						setBooksMerged(boost::lexical_cast <char> (result[5]));
						setMinimumFill(boost::lexical_cast <char> (result[6]));
						setAON(boost::lexical_cast <char> (result[7]));
						setReserved(boost::lexical_cast <char> (result[8]));
						print();
					}
				...
				struct MS_SYSTEM_INFO_DATA : public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setUpdatePortfolio(boost::lexical_cast<char>  (result[9]));
						setMarketIndex(boost::lexical_cast<long>  (result[10]));
						setDefaultSettlementPeriodNormal(boost::lexical_cast<short> (result[11]));
						setDefaultSettlementPeriodSpot(boost::lexical_cast<short> (result[12]));
						setDefaultSettlementPeriodAuction(boost::lexical_cast<short> (result[13]));
						setCompetitorPeriod(boost::lexical_cast<short> (result[14]));
						setSolicitorPeriod(boost::lexical_cast<short> (result[15]));
						setWarningPercent(boost::lexical_cast<short> (result[16]));
						setVolumeFreezePercent(boost::lexical_cast<short> (result[17]));
						setSnapQuoteTime(boost::lexical_cast<short> (result[18]));
						setReserved((result[19]));
						setBoardLotQty(boost::lexical_cast<long>  (result[20]));
						setTickSize(boost::lexical_cast<long>  (result[21]));
						setMaxGtcDays(boost::lexical_cast<short> (result[22]));
						setDisclosedQtyPercentAllowed(boost::lexical_cast<short> (result[23]));
						setRiskFreeInterestRate(boost::lexical_cast<long> (result[24]));
						print();
					}
				...
				struct MS_MESSAGE_DOWNLOAD : public DC_PACKET_WRAPPER, public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setSequenceNumber(boost::lexical_cast<double> (result[9]));
						print();
					}
					void print() const
					{
				...
				struct CONTRACT_DESC
				{
					...
					void fromString(std::string& str)
					{
						...
						setSymbol((result[1]));
						setExpiryDate(boost::lexical_cast <long> (result[2]));
						setStrikePrice(boost::lexical_cast <long> (result[3]));
						setOptionType((result[4]));
						setCALevel(boost::lexical_cast <short> (result[5]));
				...
				struct ST_ORDER_FLAGS
				{
					...
					void fromString(std::string& str)
					{
						...
						setAON(boost::lexical_cast <unsigned char> (result[0]));
						setIOC(boost::lexical_cast <unsigned char> (result[1]));
						setGTC(boost::lexical_cast <unsigned char> (result[2]));
						setDay(boost::lexical_cast <unsigned char> (result[3]));
						setMIT(boost::lexical_cast <unsigned char> (result[4]));
						setSL(boost::lexical_cast <unsigned char> (result[5]));
						setMarket(boost::lexical_cast <unsigned char> (result[6]));
						setATO(boost::lexical_cast <unsigned char> (result[7]));
						setReserved1(boost::lexical_cast <unsigned char> (result[8]));
						setReserved2(boost::lexical_cast <unsigned char> (result[9]));
						setReserved3(boost::lexical_cast <unsigned char> (result[10]));
						setFrozen(boost::lexical_cast <unsigned char> (result[11]));
						setModified(boost::lexical_cast <unsigned char> (result[12]));
						setTraded(boost::lexical_cast <unsigned char> (result[13]));
						setMatchedInd(boost::lexical_cast <unsigned char> (result[14]));
						setMF(boost::lexical_cast <unsigned char> (result[15]));
						print();
					}
				...
				struct ADDITIONAL_ORDER_FLAGS
				{
					...
					void fromString(std::string& str)
					{
						...
						setReserved1(boost::lexical_cast <unsigned char> (result[0]));
						setCOL(boost::lexical_cast <unsigned char> (result[1]));
						setReserved2(boost::lexical_cast <unsigned char> (result[2]));
						setReserved3(boost::lexical_cast <unsigned char> (result[3]));
						setSTPC(boost::lexical_cast <unsigned char> (result[4]));
						setReserved4(boost::lexical_cast <unsigned char> (result[5]));
						setReserved5(boost::lexical_cast <unsigned char> (result[6]));
						setReserved6(boost::lexical_cast <unsigned char> (result[7]));
						print();
					}
				...
				struct MS_OE_REQUEST : public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setParticipantType(boost::lexical_cast<char>  (result[9]));
						setReserved(boost::lexical_cast<char>  (result[10]));
						setCompetitorPeriod(boost::lexical_cast<short> (result[11]));
						setSolicitorPeriod(boost::lexical_cast<short> (result[12]));
						setModifiedCancelledBy(boost::lexical_cast<char>  (result[13]));
						setReserved1(boost::lexical_cast<char>  (result[14]));
						setReasonCode(boost::lexical_cast<short> (result[15]));
						setReserved2((result[16]));
						setTokenNo(boost::lexical_cast<long>  (result[17]));
						setCounterPartyBrokerId((result[18]));
						setReserved3(boost::lexical_cast<char>  (result[19]));
						setReserved4((result[20]));
						setCloseoutFlag(boost::lexical_cast<char>  (result[21]));
						setReserved5(boost::lexical_cast<char>  (result[22]));
						setOrderType(boost::lexical_cast<short> (result[23]));
						setOrderNumber(boost::lexical_cast<double> (result[24]));
						setAccountNumber((result[25]));
						setBookType(boost::lexical_cast<short> (result[26]));
						setBuySellIndicator(boost::lexical_cast<short> (result[27]));
						setDisclosedVolume(boost::lexical_cast<long>  (result[28]));
						setDisclosedVolumeRemaining(boost::lexical_cast<long>  (result[29]));
						setTotalVolumeRemaining(boost::lexical_cast<long>  (result[30]));
						setVolume(boost::lexical_cast<long>  (result[31]));
						setVolumeFilledToday(boost::lexical_cast<long>  (result[32]));
						setPrice(boost::lexical_cast<long>  (result[33]));
						setTriggerPrice(boost::lexical_cast<long>  (result[34]));
						setGoodTillDate(boost::lexical_cast<long>  (result[35]));
						setEntryDateTime(boost::lexical_cast<long>  (result[36]));
						setMinimumFillAONVolume(boost::lexical_cast<long>  (result[37]));
						setLastModified(boost::lexical_cast<long>  (result[38]));
						setBranchId(boost::lexical_cast<short>  (result[39]));
						setTraderId(boost::lexical_cast<long>  (result[40]));
						setBrokerId((result[42]));
						setcOrdFiller((result[42]));
						setOpenClose(boost::lexical_cast<char> (result[43]));
						setSettlor((result[44]));
						setProClientIndicator(boost::lexical_cast<short>(result[45]));
						setSettlementPeriod(boost::lexical_cast<short>(result[46]));
						setGiveupFlag(boost::lexical_cast<char> (result[47]));
						setClOrdId(boost::lexical_cast<long> (result[48]));

						setNnfField(boost::lexical_cast<double>(result[49]));
						setMktReplay(boost::lexical_cast<double>(result[50]));
						setPAN((result[51]));
						setAlgoID(boost::lexical_cast<long>  (result[52]));
						setReserved6(boost::lexical_cast<short> (result[53]));
						setLastActivityReference(boost::lexical_cast<long long> (result[54]));
...
#pragma pack ( push, 2)
				struct MS_OE_REQUEST_TR
				{
					...
					void fromString(std::string& str)
					{
						...
						setTransCode(boost::lexical_cast<short> (result[0]));
						setUserID(boost::lexical_cast<long> (result[1]));
						setReasonCode(boost::lexical_cast<short> (result[2]));
						setTokenNo(boost::lexical_cast<long> (result[3]));
						setAccountNumber((result[4]));
						setBookType(boost::lexical_cast<short> (result[5]));
						setBuySellIndicator(boost::lexical_cast<short> (result[6]));
						setDisclosedVolume(boost::lexical_cast<long> (result[7]));
						setVolume(boost::lexical_cast<long> (result[8]));
						setPrice(boost::lexical_cast<long> (result[9]));
						setGoodTillDate(boost::lexical_cast<long> (result[10]));
						setBranchId(boost::lexical_cast<short> (result[11]));
						setTraderId(boost::lexical_cast<long> (result[12]));
						setBrokerId((result[13]));
						setOpenClose(boost::lexical_cast<char> (result[14]));
						setSettlor((result[15]));
						setProClientIndicator(boost::lexical_cast<short> (result[16]));
						setClOrdId(boost::lexical_cast<long> (result[17]));
						setNnfField(boost::lexical_cast<double> (result[18]));
						setPAN((result[19]));
						setAlgoID(boost::lexical_cast<long> (result[20]));
						setReserved1(boost::lexical_cast<short> (result[21]));
...
#pragma pack ( push, 2)
				struct MS_OE_RESPONSE_TR
				{
					...
					void fromString(std::string& str)
					{
						...
						setTransCode(boost::lexical_cast <short> (result[0]));
						//setLogTime                       ( boost::lexical_cast <signed long  > (result [ 1 ] ));
						setUserID(boost::lexical_cast <long> (result[1]));
						setErrorCode(boost::lexical_cast <short> (result[2]));
						setTimestamp1(boost::lexical_cast <double> (result[3]));
						setTimestamp2(boost::lexical_cast <char> (result[4]));
						setModifiedCancelledBy(boost::lexical_cast <char> (result[5]));
						setReasonCode(boost::lexical_cast <short> (result[6]));
						setTokenNo(boost::lexical_cast <long> (result[7]));
						setCloseoutFlag(boost::lexical_cast <char> (result[8]));
						setOrderNumber(boost::lexical_cast <double> (result[9]));
						setAccountNumber((result[10]));
						setBookType(boost::lexical_cast <short> (result[11]));
						setBuySellIndicator(boost::lexical_cast <short> (result[12]));
						setDisclosedVolume(boost::lexical_cast <long> (result[13]));
						setDisclosedVolumeRemaining(boost::lexical_cast <long> (result[14]));
						setTotalVolumeRemaining(boost::lexical_cast <long> (result[15]));
						setVolume(boost::lexical_cast <long> (result[16]));
						setVolumeFilledToday(boost::lexical_cast <long> (result[17]));
						setPrice(boost::lexical_cast <long> (result[18]));
						setGoodTillDate(boost::lexical_cast <long> (result[19]));
						setEntryDateTime(boost::lexical_cast <long> (result[20]));
						setLastModified(boost::lexical_cast <long> (result[21]));
						setBranchId(boost::lexical_cast <short> (result[22]));
						setTraderId(boost::lexical_cast <long> (result[23]));
						setBrokerId((result[24]));
						setOpenClose(boost::lexical_cast <char> (result[25]));
						setSettlor((result[26]));
						setProClientIndicator(boost::lexical_cast <short> (result[27]));
						setClOrdId(boost::lexical_cast <long> (result[28]));
						setNnfField(boost::lexical_cast <double> (result[29]));
						setTimeStamp(boost::lexical_cast <long long> (result[30]));
						setPAN((result[31]));
						setAlgoID(boost::lexical_cast <long> (result[32]));
						setReserved1(boost::lexical_cast <short> (result[33]));
						setLastActivityReference(boost::lexical_cast <long long> (result[34]));
...
#pragma pack ( push, 2)
				...
				struct MS_OM_REQUEST_TR //: public DC_PACKET_WRAPPER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTransCode(boost::lexical_cast <short>    (result[0]));
						setUserID(boost::lexical_cast <long>    (result[1]));
						setModifiedCancelledBy(boost::lexical_cast <char>    (result[2]));
						setTokenNo(boost::lexical_cast <long>    (result[3]));
						setOrderNumber(boost::lexical_cast <double>    (result[4]));
						setAccountNumber((result[5]));
						setBookType(boost::lexical_cast <short>    (result[6]));
						setBuySellIndicator(boost::lexical_cast <short>    (result[7]));
						setDisclosedVolume(boost::lexical_cast <long>    (result[8]));
						setDisclosedVolumeRemaining(boost::lexical_cast <long>    (result[9]));
						setTotalVolumeRemaining(boost::lexical_cast <long>    (result[10]));
						setVolume(boost::lexical_cast <long>    (result[11]));
						setVolumeFilledToday(boost::lexical_cast <long>    (result[12]));
						setPrice(boost::lexical_cast <long>    (result[13]));
						setGoodTillDate(boost::lexical_cast <long>    (result[14]));
						setEntryDateTime(boost::lexical_cast <long>    (result[15]));
						setLastModified(boost::lexical_cast <long>    (result[16]));
						setBranchId(boost::lexical_cast <short>    (result[17]));
						setTraderId(boost::lexical_cast <long>    (result[18]));
						setBrokerId((result[19]));
						setOpenClose(boost::lexical_cast <char>    (result[20]));
						setSettlor((result[21]));
						setProClientIndicator(boost::lexical_cast <short>    (result[22]));
						setClOrdId(boost::lexical_cast <long>    (result[23]));
						setNnfField(boost::lexical_cast <double>    (result[24]));
						setPAN((result[25]));
						setAlgoID(boost::lexical_cast <long>    (result[26]));
						setReserved1(boost::lexical_cast <short>    (result[27]));
						setLastActivityReference(boost::lexical_cast <long long> (result[28]));
				...
				struct MS_SPD_LEG_INFO
				{
					...
					void fromString(std::string& str)
					{
						...
						setToken(boost::lexical_cast <long> (result[0]));
						setOpBrokerId((result[1]));
						setFillerX(boost::lexical_cast <char> (result[2]));
						setOrderType(boost::lexical_cast <short> (result[3]));
						setBuySell(boost::lexical_cast <short> (result[4]));
						setDisclosedVol(boost::lexical_cast <long> (result[5]));
						setDisclosedVolRemaining(boost::lexical_cast <long> (result[6]));
						setTotalVolRemaining(boost::lexical_cast <long> (result[7]));
						setVolume(boost::lexical_cast <long> (result[8]));
						setVolumeFilledToday(boost::lexical_cast <long> (result[9]));
						setPrice(boost::lexical_cast <long> (result[10]));
						setTriggerPrice(boost::lexical_cast <long> (result[11]));
						setMinFillAon(boost::lexical_cast <long> (result[12]));
						setOpenClose(boost::lexical_cast <char> (result[13]));
						setGiveupFlag(boost::lexical_cast <char> (result[14]));
						setFillerY(boost::lexical_cast <char> (result[15]));
						print();
					}
					void print() const
					{
				...
				struct MS_SPD_OE_REQUEST : public MESSAGE_HEADER
				{
					...
					void fromString(std::string& str)
					{
						...
						setTimestamp2((result[7]));
						setMessageLength(boost::lexical_cast<short>  (result[8]));
						setParticipantType1(boost::lexical_cast <char> (result[9]));
						setFiller1(boost::lexical_cast <char> (result[10]));
						setCompetitorPeriod1(boost::lexical_cast <short> (result[11]));
						setSolicitorPeriod1(boost::lexical_cast <short> (result[12]));
						setModCxlBy1(boost::lexical_cast <char> (result[13]));
						setFiller9(boost::lexical_cast <char> (result[14]));
						setReasonCode1(boost::lexical_cast <short> (result[15]));
						setStartAlpha1((result[16]));
						setEndAlpha1((result[17]));
						setToken1(boost::lexical_cast <long> (result[18]));
						setOpBrokerId1((result[19]));
						setFillerx1(boost::lexical_cast <char> (result[20]));
						setFillerOptions1((result[21]));
						setFillery1(boost::lexical_cast <char> (result[22]));
						setOrderType1(boost::lexical_cast <short> (result[23]));
						setOrderNumber1(boost::lexical_cast <double> (result[24]));
						setAccountNumber1((result[25]));
						setBookType1(boost::lexical_cast <short> (result[26]));
						setBuySell1(boost::lexical_cast <short> (result[27]));
						setDisclosedVol1(boost::lexical_cast <long> (result[28]));
						setDisclosedVolRemaining1(boost::lexical_cast <long> (result[29]));
						setTotalVolRemaining1(boost::lexical_cast <long> (result[30]));
						setVolume1(boost::lexical_cast <long> (result[31]));
						setVolumeFilledToday1(boost::lexical_cast <long> (result[32]));
						setPrice1(boost::lexical_cast <long> (result[33]));
						setTriggerPrice1(boost::lexical_cast <long> (result[34]));
						setGoodTillDate1(boost::lexical_cast <long> (result[35]));
						setEntryDateTime1(boost::lexical_cast <long> (result[36]));
						setMinFillAon1(boost::lexical_cast <long> (result[37]));
						setLastModified1(boost::lexical_cast <long> (result[38]));
						setBranchId1(boost::lexical_cast <short> (result[39]));
						setTraderId1(boost::lexical_cast <long> (result[40]));
						setBrokerId1((result[41]));
						setcOrdFiller((result[42]));
						setOpenClose1(boost::lexical_cast <char> (result[43]));
						setSettlor1((result[44]));
						setProClient1(boost::lexical_cast <short> (result[45]));
						setSettlementPeriod1(boost::lexical_cast <short> (result[46]));
						setGiveupFlag1(boost::lexical_cast <char> (result[47]));
						setFiller((result[48]));
						setNnfField(boost::lexical_cast <double> (result[49]));
						setMktReplay(boost::lexical_cast <double> (result[50]));
						setPAN((result[51]));
						setAlgoID(boost::lexical_cast <long> (result[52]));
						setAlgoCategory(boost::lexical_cast <short> (result[53]));
						setReserved((result[54]));
						setPriceDiff(boost::lexical_cast <long> (result[55]));
