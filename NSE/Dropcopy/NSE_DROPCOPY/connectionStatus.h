...
namespace FIN {
    ...
    public:
        ...
        void readConfig(const std::string& fileName)
        {
            ...
            std::string isPassword = "SESSION.PASSWORD";
            std::string isNewPassword = "SESSION.NEWPASSWORD";
            ...
            std::string isLoggingEnable = "LOGGING.IS_LOGGING_ENABLE";
            ...
            _isLoggingEnable = getParam <bool>(isLoggingEnable, false);
        }
