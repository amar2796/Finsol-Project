#include "commons.h"
namespace FIN { namespace MDGtwy {
	std::string getName ( const MDUpdateType & t) 
	{
		switch ( t ) 
		{
			...
			case MDUpdateType_IMPLIED_BID     :  return strMDUpdateType_IMPLIED_BID     ;
			case MDUpdateType_IMPLIED_OFFER   :  return strMDUpdateType_IMPLIED_OFFER   ;
