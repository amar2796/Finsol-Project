...
*/
	...
	public:
		//constructer with string of secId.
		MarketData_5Depth(const UNSIGNED_INT_16 exchange, const std::string& secId)
			:BroadCastMsgHeader(sizeof(MarketData_5Depth), BroadCastMsgType_MarketData, exchange),
			_ltp(0),
			_volume(0)
		{
			memset(_secId, 0, 25);
	...
	//		:BroadCastMsgHeader(sizeof(MarketData_10Depth), BroadCastMsgType_MarketData, exchange),
	//		_ltp(0),
	//		_volume(0)
	//	{
	...
	namespace BROADCAST
	{
		...
		public:
			...
			MarketData_default(const uint16_t exchange, const std::string& secId);
			void print() const;
